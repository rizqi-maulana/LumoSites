    ...
    plans: [
      {
        ...
        plan: "Basic",
        price: "1.000.000",
        benefit: ["Responsive design for desktop and mobile", "Simple layout and template", "Contact form", "Live Chat"],
        desc: 'Perfect for startups and small businesses looking to establish their online presence with essential features.',
      }, {
        populer: true,
        plan: "Standard",
    ...
    plans: [
      {
        ...
        benefit: [
          ...
          "Booking or information request form",
        ...
        benefit: [
          ...
          "Tourist destination video gallery",
    ...
    plans: [
      {
        ...
        benefit: [
          ...
          "Integration with vehicle search system",
          "Live chat"
        ],
        desc: 'Perfect for startups and small businesses looking to establish their online presence with essential features.',
      }, {
