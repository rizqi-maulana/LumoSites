export const AvantageData: Array<any> = [
  ...
  {
    title: "High Level SEO",
    title_id: "High Level SEO",
    ...
    description_id: "Dengan layanan pembuatan situs web kami, Anda mendapatkan akses ke kemampuan SEO tingkat tinggi. Tim kami menerapkan strategi SEO tingkat lanjut untuk mengoptimalkan visibilitas dan peringkat situs web Anda di mesin pencari. Dari riset kata kunci hingga optimasi pada halaman dan backlink, kami memastikan bahwa situs web Anda diposisikan untuk sukses dalam hasil pencarian organik. Hal ini membantu mengarahkan lalu lintas bertarget ke situs Anda, meningkatkan kehadiran online Anda dan potensi pertumbuhan bisnis."
  },
  {
