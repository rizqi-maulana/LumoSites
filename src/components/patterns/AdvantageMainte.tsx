...
export const AdvantageMainte = () => {
  ...
  return (
    <motion.div
      ...
      <div>
        <h2 className="font-semibold mb-2 text-base md:text-lg">Maintenance costs for 2 months</h2>
      ...
      <Image src={Maintenance} alt="Maintenance" className="md:w-[100px] md:h-[100px] w-10 h-10" width={100} height={100} />
    </motion.div>
  )
}