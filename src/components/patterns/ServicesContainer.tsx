  ...
  const ServicesData = [
    {
      image: LandingPage,
      title: "Landing Page",
      description: "A landing page is a focused web page designed for marketing purposes like gathering contact details or boosting conversions. With a single objective and a clear call-to-action, it often provides incentives. Landing pages are powerful tools in digital marketing for achieving specific goals.",
      href: "/details/landingpage"
    },
    {
      image: LandingPage,
      title: "Web Design",
      description: "Web design involves crafting the visual look of a website by choosing colors, layouts, and graphics to ensure an engaging and functional user experience. It encompasses considerations like user experience, branding, and SEO to create a standout and user-friendly site.",
      href: "/details/webdesign"
    ...
    },
    {
      ...
      description: "A custom website is fully tailored to the needs and preferences of businesses or individuals. Built from scratch, it offers unique design, specialized functionality, and full control to site owners. It's an ideal choice for branding and meeting specific needs.",
      href: '/details/custom'
