...
export const AdvantageHightSeo = () => {
  ...
  return (
    <motion.div
      ...
      <div>
        <h2 className="font-semibold mb-2 text-base lg:text-lg">High Level SEO</h2>
      ...
      <Image src={SEO} alt="SEO" className="lg:w-[100px] lg:h-[100px] w-10 h-10" width={100} height={100} />
    </motion.div>
  )
}