...
export const ServicesItem = ({ title, description, image, href }: ServivesType) => {
  ...
  return (
    <Links href={href}
      className={clsx('services-items md:p-5 p-2 flex justify-between w-[200px] md:w-max md:mb-10 mb-0 border-solid rounded-[5px] hover:shadow-2xl hover:cursor-pointer group relative transition-all duration-300 ease delay-[.2s] animate__animated', { 'animate__zoomIn': isVisible })}>
      <div>
        <div className="flex items-center group-hover:md:opacity-0 transition-all duration-300 ease delay-[.2s]">
        ...
        <div className="md:opacity-0 opacity-95 h-full w-[90%] flex flex-col justify-center group-hover:opacity-95 absolute top-0 transition-all delay-[.2s] ease">
