...
export const ServicesItem = ({ title, description, image, href }: ServivesType) => {
  return (
    <div className="p-5 w-[600px] mb-10 border-solid border-red-500  overflow-hidden border-0 hover:border-2 hover:cursor-pointer">
      <div className="flex items-center relative hover:left-[-500px]">
