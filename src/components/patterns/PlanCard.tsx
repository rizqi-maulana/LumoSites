...
export const PlanCard = ({ plan, price, benefit, isPopuler, desc }: PlanCardType) => {
  ...
  return (
    <div className={'bg-white dark:bg-slate-950 rounded-xl w-[80%] md:w-[370px] px-5 py-6 shadow-2xl'}>
      ...
      <Buttons className="!w-full !py-[6px] !from-[#110820] dark:!from-blue-400 dark:!via-purple-500 dark:!to-indigo-200 !to-[#110820] rounded-md px-1 text-white mb-2" type="button">Select</Buttons>
