...
const CTA = () => {
  return (
    <div className="bg-[#1B2538] w-full lg:h-[700px] h-max lg:flex block justify-evenly items-center py-10 lg:px-0 px-10 relative">
      ...
      {/* stats */}
      <Image src={Starts} width={200} height={200} alt={"stars"} className="absolute right-0 w-40 lg:w-[200px]" />
      <Image src={Starts} width={200} height={200} alt={"stars"} className="absolute bottom-0 right-0 w-40 lg:w-[200px]" />
      <Image src={Starts} width={200} height={200} alt={"stars"} className="absolute lg:right-52 right-40 -bottom-[70px] w-40 lg:w-[200px]" />
      <Image src={Starts} width={200} height={200} alt={"stars"} className="absolute lg:block hidden right-[430px] -bottom-[70px] w-40 lg:w-[200px]" />
      <Image src={Starts} width={200} height={200} alt={"stars"} className="absolute lg:left-[700px] left-0 -bottom-[70px] w-40 lg:w-[200px]" />
    </div>
  )
}
