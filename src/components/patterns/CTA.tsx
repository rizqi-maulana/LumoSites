      ...
      <div className="bg-[#1B2538] w-full lg:h-[700px] h-max lg:flex block justify-evenly items-center py-10 lg:px-0 px-10 relative">
        <div>
          <div className='text-3xl lg:text-6xl font-semibold lg:w-[700px] w-full'>
            ...
            <h2 className="text-white"><Translate to="Mulailah Membangun">Start Building Your</Translate></h2>
            <h2 className="text-[#6C9BFF] mt-4"><Translate to="Situs Impian Sekarang!">Dream Website Now!</Translate></h2>
          </div>
