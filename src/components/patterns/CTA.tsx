...
const CTA = () => {
  ...
  // )
  return (
    <section className="py-28 dark:!bg-slate-800" style={{ background: "linear-gradient(152.92deg, rgba(192, 132, 252, 0.2) 4.54%, rgba(232, 121, 249, 0.17) 34.2%, rgba(192, 132, 252, 0.1) 77.55%)" }}>
      <div className="max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
        ...
        <Buttons className='md:m-0 relative z-20 !mt-4' type='button'>Get started</Buttons>
