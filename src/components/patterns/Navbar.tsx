...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative boder border-transparent dark:bg-black dark:border-white/[0.2] shadow-input flex md:justify-center space-x-4 my-2 md:my-0 mr-0 ml-5 md:ml-0 md:mr-10 py-0 md:py-6 "
    >
      {children}
    </nav>
  );
