...
export function TeamCard({ image, title, name, animateDelay }: Type) {
  ...
  return (
    ...
    >
      <div className={clsx('team-card w-[160px] relative flex flex-shrink-0 mb-[20px] h-[220px] hover:cursor-pointer bg-[#D4D5D6] rounded-md shadow-lg overflow-hidden animate__animated animated__fast', {
