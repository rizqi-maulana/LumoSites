            ...
            <div className='relative md:-left-5'>
                <div className='md:flex flex-col absolute left-10 md:left-[-50px] items-center gap-4 pt-8 z-[100]'>
                    ...
                    <div className='flex justify-center relative gap-10'>
                        <div className='mt-10 pr-8 pl-8 animate-floating pb-3  pt-3 backdrop-blur-sm bg-white/65 shadow-lg flex-col border border-black rounded-md flex justify-center items-center'>
                            <h3 className='text-[#216BFF] font-semibold'>Include</h3>
                            <p className='text-[#8D868C] text-[13px] text-center'>Domain & hosting</p>
                        </div>
                        <div className='mt-6 mr-10 pr-5 pl-5 animate-floating backdrop-blur-sm bg-white/65 shadow-lg h-[50px] py-8 md:py-0 border border-black rounded-md flex justify-center items-center text-[#8D868C] text-[13px] text-center'>High level SEO</div>
                    </div>
                </div>
                <div className='md:bg-[#E78F9A] bg-[#e78f9971] z-[90] relative md:-top-[50px] md:w-96 w-80 h-80 blur-[80px] rounded-md' />
                <div className='md:bg-[#85A6F4] bg-[#85a6f482] z-[90] absolute -left-[200px] md:bottom-[-150px] w-96 h-80 blur-[80px] rounded-md' />
            </div>
