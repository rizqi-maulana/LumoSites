...
function Services() {
    return (
        <section className="w-full flex items-center justify-center flex-col relative dark:bg-grid-white/[0.1] bg-grid-black/[0.1]">
            <div className="bg-gradient-to-t from-[#eff9fb] dark:from-slate-900 absolute to-transparent w-full -top-48 h-[200px]" />
            <div className="bg-gradient-to-b from-[#eff9fb] dark:from-slate-900 absolute to-transparent top-0 w-full h-[200px]" />
            <div className="bg-gradient-to-t from-[#eff9fb] dark:from-slate-900 absolute to-transparent w-full bottom-0 h-[200px]" />
