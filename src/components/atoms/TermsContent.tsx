export const TermsContent = () => {
    return (
        <section className="px-3 md:px-32 mt-10">
            ...
            <article>
                ...
                <h3 className="font-semibold mt-5">Kebijakan Privasi</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">Penghentian layanan, apabila</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">Kewajiban pelanggan</h3>
                ...
                <h3 className="font-semibold mt-5">Materi</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">Pengerjaan</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">Revisi dan penambahan fitur</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">Garansi</h3>
                <ul className="list-disc text-sm md:text-base">
                ...
                <h3 className="font-semibold mt-5">ketentuan Pembayaran</h3>
                <ul className="list-disc text-sm md:text-base">
