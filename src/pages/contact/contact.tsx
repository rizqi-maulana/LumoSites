        ...
        <>
            <section className="flex items-center justify-between w-full px-3 lg:px-32 mt-16 lg:mt-0">
                <div className='text-4xl lg:text-6xl font-bold w-[300px] lg:w-[700px]'>
                    <div className='h-max overflow-hidden w-full mb-2 lg:mb-5 pb-2'>
                        <h1 className="text-[#1B325B] animate__animated animate__fadeInUp animate__fast"><Translate to="Hubungi kami dengan Mudah">Contact us Easily</Translate></h1>
                    </div>
                </div>
            ...
            <section className="mx-2 lg:mx-32 lg:flex block justify-evenly relative z-50">
                <div className="w-full mb-20">
                    ...
                    <div className='h-max overflow-hidden w-full lg:w-[500px] pb-2'>
                        <p className="w-[90%] lg:w-[450px] text-sm animate__animated animate__fadeInUp animate__fast">
            ...
            <section className="lg:flex block items-center justify-between w-full px-3 lg:px-32 bg-[#1B2538] py-16">
                <div className='text-4xl lg:text-7xl font-semibold'>
                    <h1 className="text-white"><Translate to="Lokasi">Location</Translate></h1>
                    <h1 className="text-[#6C9BFF] mt-2 lg:mt-5"><Translate to="Dimana kami">Where we</Translate><span className="text-white"><Translate to=" berada">are</Translate></span></h1>
