    ...
    return (
        <>
            <section className="flex items-center justify-between w-full px-3 lg:px-32 mt-16 lg:mt-0">
                <div className='text-4xl lg:text-6xl font-bold w-[300px] lg:w-[700px]'>
                    <div className='h-max overflow-hidden w-full mb-2 lg:mb-5 pb-2'>
                        <h1 className="text-[#1B325B] animate__animated animate__fadeInUp animate__fast" style={{ fontFamily: "Poppins", fontWeight: "bold" }}><Translate to="Hubungi kami dengan Mudah">Contact us Easily</Translate></h1>
                    </div>
                </div>
            ...
            <section className="mx-2 lg:mx-32 lg:flex block justify-evenly relative z-50">
                <div className="w-full mb-20">
                    <div className='h-max overflow-hidden w-full lg:w-[500px] pb-2'>
                        <h1 className="text-2xl lg:text-3xl font-semibold mb-3 animate__animated animate__fadeInUp animate__fast" style={{ fontFamily: "Poppins", fontWeight: "semibold" }}>Leave a message</h1>
                    </div>
                    <div className='h-max overflow-hidden w-full lg:w-[500px] pb-2'>
                        <p className="w-[90%] lg:w-[450px] text-sm lg:text-base animate__animated animate__fadeInUp animate__fast">
                            <Translate to="Jika ini menarik minat Anda, kami dengan hangat menyambut Anda untuk menghubungi kami. Apakah Anda
                            Jika Anda memiliki pertanyaan, memerlukan informasi lebih lanjut, atau siap memulai, tim kami siap membantu Anda
                            setiap langkahnya. Jangan ragu untuk menghubungi kami dan mencari tahu bagaimana kami dapat mewujudkan visi Anda
                            untuk hidup!">If this piques your interest, we warmly welcome you to get in touch with us. Whether you
            ...
            <div className="flex lg:px-32 mt-10">
                ...
                <p className="lg:mx-10 mx-5 text-sm lg:text-lg"><Translate to="Atau">Or</Translate></p>
                <div className="w-[50%] mx-auto h-[1px] bg-black mb-7 mt-5 lg:mb-20" />
            </div>
            ...
            <section className="lg:flex block items-center justify-between w-full px-3 lg:px-32 bg-[#1B2538] py-16">
                <div className='text-4xl lg:text-7xl font-semibold'>
                    <h1 className="text-white" style={{ fontFamily: "Poppins", fontWeight: "bold" }}><Translate to="Lokasi">Location</Translate></h1>
                    <h1 className="text-[#6C9BFF] mt-2 lg:mt-5" style={{ fontFamily: "Poppins", fontWeight: "bold" }}><Translate to="Dimana kami">Where we </Translate><span className="text-white"><Translate to=" berada">are</Translate></span></h1>
