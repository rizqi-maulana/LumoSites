        ...
        <>
            ...
            <section className="w-full flex flex-col md:flex-row justify-evenly pt-[150px] px-[7%] md:px-0">
                <div className="lg:w-[400px] md:w-[40%] lg:text-[24px] md:mb-0 mb-16">
                    ...
                    <p className="lg:w-[440px] text-[#303232]">Merancang website yang menarik dan fungsional sebagai pilihan terbaik bagi klien yang ingin meningkatkan kehadiran online pelanggan dengan inovasi dan kreativitas. </p>
