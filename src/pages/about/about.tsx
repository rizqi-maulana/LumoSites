        ...
        <>
            ...
            <section className="w-full flex flex-col-reverse lg:flex-row justify-evenly lg:pt-[150px] pt-14 mt-[150px] pb-[150px]">
                <div className="flex flex-col gap-4 overflow-auto">
                    <h3 className="w-full text-[46px] font-bold text-[#1B325B] lg:px-0 px-[7%]"><Translate to="Team kami">Our team</Translate></h3>
                ...
                <div className="lg:w-[400px] text-[24px] lg:mb-0 mb-16 lg:px-0 px-[7%] ">
                    <h3 className="font-semibold mb-2"><Translate to="Misi kami">Our mission</Translate></h3>
